...
- June 28, 2025: **INLINE HEADER/FOOTER EDITING**: Added double-click functionality to headers and footers for instant inline editing without accessing page setup. Headers and footers now show hover effects and display placeholder text when empty. Double-clicking opens a floating rich text editor overlay positioned near the clicked element with full formatting capabilities, variable insertion, and immediate preview updates. Provides seamless editing experience directly on script pages.
