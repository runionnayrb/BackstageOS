...
const RELEASE_NOTES = [
  {
    ...
    features: [
      ...
      "<strong><u>SHARE & EXPORT REPORTS:</u></strong>",
      "Email reports directly from the app to your distribution lists with PDF attachments",
      "Download professional PDF reports with numbered lists and page numbers",
      "Clear, formatted PDFs named with Show, Report Title, and Date",
