...
const RELEASE_NOTES = [
  {
    ...
    features: [
      ...
      "<strong><u>IMPROVED PDF EXPORTS:</u></strong>",
      "Numbered and bulleted lists now appear correctly in PDF reports",
      "Page numbers displayed in footer as 'Page X of X'",
      "Better spacing and formatting throughout the document",
      "PDF filenames now include Show Name, Report Title, and Report Date",
