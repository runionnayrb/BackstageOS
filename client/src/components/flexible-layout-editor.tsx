...
export const FlexibleLayoutEditor = forwardRef<FlexibleLayoutEditorRef, FlexibleLayoutEditorProps>(({
  ...
  // Removed obsolete convertToGridLayouts function - now using controlled layout system

  // Old layout update code removed - now using controlled layout system

  // Old layout change handlers removed - now using controlled layout system
