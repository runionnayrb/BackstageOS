...
export function EmailComposer({ 
  ...
  const MobileComposer = () => (
    <Drawer open={isOpen} onOpenChange={handleClose}>
      <DrawerContent className="h-[85vh] bg-white">
        <DrawerHeader className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
          <Button 
            variant="ghost" 
  ...
  const DesktopComposer = () => (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="w-[95vw] max-w-4xl h-[95vh] max-h-[90vh] flex flex-col p-6 bg-white">
