                                    ...
                                    .map((item) => (
                                      ...
                                      >
                                        <div className="flex items-center gap-2">
                                          ...
                                          {item.duration && <div className="text-sm text-muted-foreground flex gap-1" style={{width: '140px'}}><span>Length:</span><span className="text-right flex-1">{item.duration}</span></div>}
                                        </div>
                                      </div>
                                    ))}
                                </div>
